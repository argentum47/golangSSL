// golang script to discover, renew and monitor SSL certificates using CertifyTheWeb API
...
func main() {
	...
	log.Println("SSL Certificate Monitoring and Renewal Tool started")
	select {}
}

// Function to alert on renewal failure
